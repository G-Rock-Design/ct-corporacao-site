...
export function Structure() {
  return (
    <section id="estrutura" className="py-16 md:py-32 px-6 bg-brand-black relative text-white">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8">
          ...
          <div className="glass-dark p-8 md:p-10 rounded-3xl glow-border glass-card-hover group flex flex-col items-center text-center">
          ...
          <div className="glass-dark p-8 md:p-10 rounded-3xl glow-border glass-card-hover group flex flex-col items-center text-center" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="glass-dark p-8 md:p-10 rounded-3xl glow-border glass-card-hover group flex flex-col items-center text-center" style={{ animationDelay: '0.2s' }}>
